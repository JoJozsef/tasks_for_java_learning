...
public class TicTacToe {
    ...
    public static int checkWin(char[][] board){
        ...
        int lelfDiagonal = checkLeft(board);
        if(Math.abs(lelfDiagonal) == 3) return lelfDiagonal;

        int rightDiagonal = checkLeft(board);
